...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aicssegmentation-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15398&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aicssegmentation-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aicssegmentation` can be installed with:

```
conda install aicssegmentation
```

It is possible to list all of the versions of `aicssegmentation` available on your platform with:
